...
public class InMemoryPersistence {
    ...
    public InMemoryPersistence() {
        ...
        ads.add(new AdVO(3, "CHALET", "descripción de un chalet", Arrays.asList(2,5), 300, 200, null, null));
        ...
        ads.add(new AdVO(7, "GARAGE", "Garaje en el REFORMADO ATICO centro de Albacete", Collections.<Integer>emptyList(), 300, null, null, null));
        ads.add(new AdVO(8, "CHALET", "prueba prueba prueba prueba prueba prueba prueba prueba prueba prueba prueba prueba prueba prueba prueba prueba prueba prueba prueba prueba prueba prueba prueba prueba prueba prueba prueba prueba prueba prueba prueba prueba prueba prueba prueba prueba prueba prueba prueba prueba prueba prueba prueba prueba prueba  Maravilloso chalet situado en lAs afueras de un pequeño pueblo rural. El entorno es espectacular, las vistas magníficas. ¡Cómprelo ahora!", Arrays.asList(1, 7), 300, null, null, null));
